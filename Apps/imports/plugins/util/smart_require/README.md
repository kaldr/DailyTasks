...
- [Smart Require](#smart-require)
	- [目录](#目录)
	- [1. 必要说明](#1-必要说明)
	- [2. require_config](#2-requireconfig)
		- [1. 调取某个文件夹下的配置](#1-调取某个文件夹下的配置)
		- [2. 其他用法举例](#2-其他用法举例)
	- [3. require_component](#3-requirecomponent)
	...
	- [4. require_routes （in progress）](#4-requireroutes-in-progress)
	- [5. require_api](#5-requireapi)
		- [1. 举例](#1-举例)
		- [2. 注意](#2-注意)
